  ...
  return (
    <div className="flex flex-col justify-center items-center text-xl rounded text-black mx-2">
      ...
      <div className="flex text-base font-medium ">
        ...
        <button id="blueBtn2" className=" px-4 py-1 w-full border-l border-y-2 border-r-2 border-[#3b82f6] hover:text-white hover:bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-r" onClick={reset}>Reset</button>
      </div>
    </div>
  );
}
